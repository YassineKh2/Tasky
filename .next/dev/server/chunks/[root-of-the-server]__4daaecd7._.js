...
async function GET() {
    try {
        const tasks = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["taskDefinitionService"].getAll();
        // Parse JSON fields
        const parsedTasks = tasks.map((task)=>({
                ...task,
                recurringDays: typeof task.recurringDays === "string" ? JSON.parse(task.recurringDays) : task.recurringDays
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(parsedTasks);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const task = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["taskDefinitionService"].create({
            text: body.text,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4daaecd7._.js.map