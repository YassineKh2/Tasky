...
"[project]/app/api/assignments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let assignments;
        if (dateStr) {
            assignments = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["taskAssignmentService"].getByDate(dateStr);
        } else if (taskId) {
            assignments = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["taskAssignmentService"].getByTaskId(taskId);
        } else if (startDate && endDate) {
            assignments = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["taskAssignmentService"].getByDateRange(startDate, endDate);
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Please provide either dateStr, taskId, or startDate+endDate parameters"
            }, {
                status: 400
            });
        }
...
async function POST(request) {
    try {
        ...
        const assignment = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["taskAssignmentService"].create({
            taskId: body.taskId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__418d9996._.js.map